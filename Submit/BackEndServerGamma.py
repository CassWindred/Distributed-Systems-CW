...
backupnames = ["PYRONAME:back.updateinterface.beta", "PYRONAME:back.updateinterface.alpha"]
workingbackups = []
...
ns.register("back.interface.gamma", uri)  # register the object with a name in the name server
uri = daemon.register(UpdateInterface)
ns.register("back.updateinterface.gamma", uri)

print("Backend Gamma Ready.")
